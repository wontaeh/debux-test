...
console.log('installHook.js is invoked');
...
// export const excuteInstallHook = (result) => {
...
//   if (!__ReactSightHasRun) {
//     if (!result) console.warn('[React-Sight]: React Sight requires React Dev Tools to be installed.');
//     const reactInstances = result._renderers || null;
//     const instance = reactInstances[Object.keys(reactInstances)[0]];
//     // const reactRoot = window.document.body.childNodes;
//     const devTools = result;
